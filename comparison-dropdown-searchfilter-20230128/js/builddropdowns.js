...
shipselect.options[shipselect.options.length] = new Option('Select from list or search ...', '9999999');
ship1select.options[ship1select.options.length] = new Option('Select from list or search ...', '9999999');
